...
public class ConexionDB {
    ...
    private static final String URL = "jdbc:sqlserver://localhost:14033;database=dbKardex;encrypt=false;sendStringParametersAsUnicode=false;characterEncoding=UTF-8;";

    // Usuario y contraseña para autenticarse
    private static final String USER = "sa";
    private static final String PASSWORD = "LosPinos123";
